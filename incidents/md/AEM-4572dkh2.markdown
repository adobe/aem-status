...
Our errors were observed in Indian datacenters (Chennai, Delhi, Mumbai, Bangalore) while Cloudflare scoped their incident to Singapore (SIN). The most likely explanation is that Durable Objects requests originating from India were being routed to Singapore during the incident, exposing our Indian traffic to the degraded region. The recovery we saw at 07:42 UTC is consistent with Cloudflare re-routing away from the affected region around that time, ahead of formally posting and later resolving the public incident.
